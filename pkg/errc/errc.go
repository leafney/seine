...
const (
	...
	ErrTokenPermissionOrTimeout = 4022 // Token无权限或已过期
	ErrExisted                  = 4023 // 资源已存在
	ErrPhoneExist               = 4024 // 手机号已存在
	ErrEmailExist               = 4025 // 邮箱已存在
...
var ErrMsgZh = map[int]string{
	...
	ErrTokenPermissionOrTimeout: "Token无权限或已过期",
}
